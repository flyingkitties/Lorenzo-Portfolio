...
function Header() {
  return (
    <div className="flex item-center bg-[#fbfaf6] opacity-80 z-10 shadow-md rounded-sm sticky top-0 ">
      <div className="flex items-center space-x-5 p-3 pl-5 lg:pl-10">
        <p className="text-2xl lg:text-3xl px-3 text-[#595260]">@Licurgen</p>
      </div>
