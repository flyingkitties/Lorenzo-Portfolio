...
function Header() {
  return (
    <div className="flex item-center bg-[#DFDFDE] opacity-90 z-10 shadow-md rounded-sm sticky top-0 transparent">
      <div className="flex items-center space-x-5 p-2 pl-5 lg:pl-10">
        <p className="text-2xl lg:text-3xl px-3 text-[#595260]">
          Lorenzo Polato
        </p>
      </div>
      <div className="flex absolute right-5 lg:right-10  items-center text-[#595260]  ">
        <SocialIcon
