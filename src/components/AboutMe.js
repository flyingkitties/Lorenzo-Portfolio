  ...
  return (
    <div>
      {!show ? (
        <div
          onClick={isClicked}
          className=" bg-[#FFFFFF] rounded-lg shadow-lg z-5 drop-shadow-2xl ">
          <div>
            ...
            <div className=" px-3 items-center ">
              ...
              <div className=" space-y-3 text-[#595260] text-justify px-1">
                <p>
                  Hi, I'm Lorenzo, a junior developer who loves creating
                  beautiful and functional apps with Swift and UIKit.{" "}
                </p>

                <p className="pb-5">
                  If you are interested in working with me or just want to say
        ...
        <div className=" z-50 bg-[#FFFFFF] rounded-lg shadow-lg z-5 drop-shadow-2xl ">
          <div className="flex relative bg-gradient-to-b from-[#DFDFDE] items-center rounded-t-lg p-2 pb-5 ">
            <p className="p-1 text-left text-[#595260] font-semibold">
              About me
            </p>
